    ...
    <div class="p-4">
        <div class="bg-white rounded-lg overflow-hidden relative">
            <div class="flex absolute top-2 left-2">
                <a href="{{ route('category.index') }}" class="text-sm font-medium text-white flex items-center transition-all duration-300 bg-[#2A4759] hover::bg-[#1f3445] p-3 py-2 rounded-lg backdrop-blur-sm border border-white">
                    <i data-feather="arrow-left" class="w-5 h-5 text-white"></i>
                    <span class="ml-2 text-white">Detail Buku</span>
                </a>
            </div>
