                ...
                @if (Request::is('category') || Request::is('books') || Request::is('borrow'))
                    <div class="flex p-2 items-center">
                        ...
                        method="get" class="w-full flex justify-end ml-3">
                            ...
                            <button type="submit"
                                class="transition-all duration-500 bg-[#2A4759] text-white' : 'text-gray-700 px-4 rounded-lg ml-2 font-medium text-sm text-white shadow-lg focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:shadow-none shadow-blue-100">Search</button>
                        </form>
                        {{-- <form
